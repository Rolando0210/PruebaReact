SampleAppUtilities = (function () {
    var vocalGuidanceSoundFilesDirectory = "./libraries/facetec/sample-app-resources/Vocal_Guidance_Audio_Files/";
    ...
    function enableKeyboardAccessibilityStyling(enable) {
    ...
    function showAuditTrailImages(sessionResult, idScanResult) {
        ...
        if (idScanResult != null && idScanResult.backImages != null && idScanResult.backImages.length > 0) {
            // Add ID Scan Back images
            auditTrailImages.unshift("data:image/jpeg;base64," + idScanResult.backImages[0]);
        }
