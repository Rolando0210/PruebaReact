...
var Enrollment = /** @class */ (function () {
    var startEnrollmentValidationProcessMethod, loadSelfieImageMethod, loadLivenessCheckResponseBodyMethod;

    function Enrollment(sessionToken, sampleAppControllerReference, startEnrollmentValidationProcess, startInIFrameMode, loadSelfieImage, loadLivenessCheckResponseBody) {
