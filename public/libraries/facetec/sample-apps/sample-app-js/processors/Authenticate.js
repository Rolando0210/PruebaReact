...
var Authenticate = /** @class */ (function () {
    var enrollmentIdentifierValue, loadSelfieImageMethod, loadLivenessCheckResponseBodyMethod ;
    function Authenticate(sessionToken, sampleAppControllerReference, startInIFrameMode, enrollmentIdentifier, loadSelfieImage, loadLivenessCheckResponseBody) {
        enrollmentIdentifierValue = enrollmentIdentifier;
    ...
    //
    Authenticate.prototype.processSessionResultWhileFaceTecSDKWaits = function (sessionResult, faceScanResultCallback) {
        var _this = this;
        ...
        var parameters = {
            ...
            externalDatabaseRefID: enrollmentIdentifierValue
        };
